# Projeto Integrador - Empréstimo
***Bella Vista***
Um modelo para o desenvolvimento do Projeto Integrador do Curso de Técnico em Desenvolvimento de Sistemas para a Internet Integrado ao Ensino Médio do IFC - Campus Araquari.

***Bella Vista*** é um projeto desenvolvido usando o framework front-end VueJS, e o back-end desenvolvido por Django. O objetivo do projeto, idealmente, é criar um sistema para uma pousada, possibilitando que seus clientes possam fazer reservas diretamente no site eos funcionários possam gerenciar tais reservas de forma dinâmica.
...
# 2. Situação Problema
Como em muitos estabelecimentos do ramo, enfrentam desafios comuns relacionados à gestão de reservas e controle de quartos. A comunicação entre os funcionários nem sempre é eficiente, resultando em erros de reserva ou, às vezes, em clientes que chegam ao estabelecimento com seu quarto ainda não pronto.

Para superar esses obstáculos, identificamos a necessidade de implementar uma solução eficaz: uma site para nossos clientes e funcionários. Com essa inovação, nossos clientes serão orientados pelo desing intuito sobre como utilizar o sistema, permitindo-lhes fazer suas reservas de forma rápida e precisa. Uma vez feito a reserva, este será automaticamente cadastrada ao sistema, que poderá ser consultado com facilidade.

# 3. Descrição da proposta
Nosso software tem como foco principal simplificar a gestão de reservas e controle de quartos, abordando os desafios enfrentados pelo Bella Vista.

**Foco de ação do software:**

-   O software permitirá aos clientes fazerem reservas de forma autônoma através de um site, onde poderão selecionar o(s) quarto(s) desejados.
-   Além disso, o sistema permitirá que os funcionários gerenciem os quartos disponíveis.

**Níveis de usuário do sistema:**

-   Existirá um login para os clientes, permitindo-lhes permissão para fazer reservas.
-   Existirá um login para os funcionários, permitindo-lhes acesso total ao sistema.

**Funcionalidades do software:**

-   Para os clientes: possibilitará a realização de reservas de forma autônoma, através da seleção de quartos disponíveis.
